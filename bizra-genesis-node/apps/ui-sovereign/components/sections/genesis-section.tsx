...
export function GenesisSection() {
  ...
  const timelineEvents = [
    { date: "Ramadan 2023", event: "The Seed Written", location: "Global" },
    { date: "2023-2024", event: "The Great Refinement", location: "31 Months" },
    { date: "Feb 2025", event: "The Forge: Masterpiece Seal", location: "0.9536 Ihsan" },
    { date: "Today", event: "The Apotheosis: BIZRA Live", location: "Federation MVP" },
  ]
