...
export function GenesisStory({ onEnter }: GenesisStoryProps) {
      ...
      <section className="py-20 px-8 border-t border-[#C9A962]/10 bg-gradient-to-b from-card/30 to-[#0A1628]">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="mt-12">
            <button
              onClick={onEnter}
              className="inline-flex items-center gap-2 px-6 py-3 rounded-lg bg-[#C9A962]/10 border border-[#C9A962]/30 text-[#C9A962] hover:bg-[#C9A962]/20 transition-colors group"
            >
