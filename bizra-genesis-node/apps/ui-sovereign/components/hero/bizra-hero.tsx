...
export function BizraHero() {
  ...
  const subtitleText = "Sovereign Intelligence Architecture | Verified Masterpiece Grade"
    ...
    >
      ...
      >
        <div className="flex flex-col items-start">
          ...
          <span className="text-sm font-mono text-[#C9A962]/70">v7.0.0-PRO</span>
        </div>
        <div className="flex flex-col items-start">
          <span className="text-[10px] font-mono text-[#C9A962]/40 tracking-wider mb-1">GRADE</span>
          <span className="text-sm font-mono text-[#C9A962]/70">MASTERPIECE</span>
        </div>
        <div className="flex flex-col items-start">
      ...
      >
        ...
        <div className="flex flex-col items-end">
          <span className="text-[10px] font-mono text-[#C9A962]/40 tracking-wider mb-1">IHSAN PROOF</span>
          <span className="text-sm font-mono text-[#C9A962]/70">0.9536</span>
        </div>
      </div>
