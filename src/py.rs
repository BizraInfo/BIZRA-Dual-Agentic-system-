...
impl BizraFfiBridge {
    ...
    ///
    /// Args:
    ///     require_hardware: If true, fail if no TPM 2.0 hardware found
    ///
    /// Returns:
    ///     bool: True if hardware TPM, False if software emulation
    pub fn init_tpm(&mut self, require_hardware: bool) -> PyResult<bool> {
